...
import 'package:flutter_application_1/models/resultdata.dart';
...
class _DetailsPageState extends State<DetailsPage> {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding:
                              EdgeInsets.only(left: deviceSize.width * 0.08),
                          child: const Text(
                            "Details in!",
                            style: TextStyle(
                                fontFamily: "Inria Sans",
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  filled: true,
                                  fillColor:
                                      Color(0xff1E4934).withOpacity(0.74),
  ...
  Future<void> helper(var userData) async {
    ...
    try {
      var response = await BaseClient.post(convert.jsonEncode(data));
      ...
      Navigator.of(context).push(MaterialPageRoute(
          builder: (_) => ResultsPage(resultData: resultData)));
    } catch (e) {
      setState(() {
        isLoading = false;
      });
      const snackbar = SnackBar(content: Text("Failed to get results"));
